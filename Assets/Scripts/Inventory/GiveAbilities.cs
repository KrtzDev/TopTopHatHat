...
public class GiveAbilities : Singleton<GiveAbilities>
{
    ...
    public void Ability18() // if you have more than 5 top hats enemies deal double damage
    {

    }

    public void Ability19() // you deal no damage for the first 5 seconds of each stage
    {

    }

    public void Ability20() // you deal halve damage for 2 seconds after having dashed
    {

    }

    public void Ability21() // you deal havel damage for 2 seconds after slaying an enemy
    {
